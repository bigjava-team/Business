...
<body style="margin: 0px; padding: 0px;">
	...
	<div id="d" class="contenttwo">
		...
		<div class="search bar7">
			<form action="index_searchTextQueryProduct?paging.presentPage=1"
				method="post">
			...
			<div class="content">
				<div class="aa">
					...
					<s:iterator value="listCategoryProduct" var="listCategoryProducts">
						<div class="lanmusi"
							onclick="queryProduct(${listCategoryProducts.p_id })">
							<div class="juzhong">
								<img
									src="${fileImageAction.urlImage }${listCategoryProducts.p_image }"
									height="35%" />
							</div>
							<!--栏目内容-->
				...
				<div class="aa">
					...
					<div class="lanmusi">
						<div class="空的div">
							<img src="${pageContext.request.contextPath }/zp1/images/0.jpg"
								height="60%" width="100%" />
						</div>
						<!--栏目内容-->
						<div class="wenziz3">非常好的鞋子</div>
						<p>
